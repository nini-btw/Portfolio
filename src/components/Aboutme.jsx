                    ...
                    <Row>
                        <Col md={6} xs={12} className='skills'>
                            <div className="">
                                ...
                                <p>Hello! I&apos;m <strong>Mohammed</strong>, a <strong>MERN Stack Developer</strong> based in <strong>Oran</strong> with a <strong>Bachelor’s degree in Computer Science</strong>. I’m passionate about building dynamic, user-focused applications and bringing clients’ visions to life through <strong>scalable and efficient software solutions</strong>. Let’s work together to turn your ideas into reality!</p>
